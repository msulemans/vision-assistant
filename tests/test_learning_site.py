...
class LearningSiteContractTest(unittest.TestCase):
    ...
    def test_current_evidence_and_honest_boundaries_are_visible(self) -> None:
        for phrase in (
            "M003 · live capture pending",
            "25 passing · 19 product + 6 learning",
            "None acquired",
            "Intentionally absent",
            "selection_timed_out",
            "One harmless live selection",
        ):
    ...
    def test_all_seventeen_milestones_are_registered_once(self) -> None:
        ...
        self.assertIn('status: "current", title: "Explicit screenshot ingest and capture"', self.js)
