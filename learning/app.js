...
const milestones = [
  ...
  { id: 10, phase: 3, status: "current", title: "Typed action intents and policy—no execution", build: "Define observe, click, type, key, scroll, cancel, finish, target preview, and consequence policy.", gate: "Adversarial proposals cannot bypass schema, scope, approval, or budget." },
