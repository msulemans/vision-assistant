...
const milestones = [
  ...
  { id: 15, phase: 4, status: "current", title: "Profiles, packaging, and offline verification", build: "Package only measured passing profiles after M009; M014 is required only for action-enabled packaging.", gate: "A clean Mac reproduces read-only operation fully offline." },
