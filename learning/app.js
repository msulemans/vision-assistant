...
const milestones = [
  ...
  { id: 13, phase: 3, status: "current", title: "Supervised mouse and keyboard execution", build: "Add opt-in Accessibility execution, visible target overlay, confirmation, stop, and observation.", gate: "Zero wrong-target, secret-field, approval-bypass, or stale-frame actions." },
