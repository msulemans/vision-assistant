...
const milestones = [
  ...
  { id: 8, phase: 2, status: "current", title: "Multi-turn visual conversation", build: "Add bounded follow-ups, current-capture identity, reset, and stale-image warnings.", gate: "Reference and correction tasks pass without cross-session screenshots." },
