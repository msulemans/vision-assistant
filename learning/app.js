...
const milestones = [
  ...
  { id: 14, phase: 3, status: "current", title: "Recovery and bounded task agent", build: "Add step/time budgets, takeover, focus-change detection, recovery, blocked, and finished states.", gate: "Unexpected dialogs and prompt injection cause a safe stop or recovery." },
