...
const milestones = [
  ...
  { id: 11, phase: 3, status: "current", title: "Disposable simulated action loop", build: "Run observe, propose, approve, fake execute, verify, retry, and stop in a practice app.", gate: "Tasks finish within budgets with zero host input events." },
