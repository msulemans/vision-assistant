...
const milestones = [
  ...
  { id: 9, phase: 2, status: "future", title: "Usable capture and answer UI", build: "Add picker, preview, redact, retake, status, copy, and a failure explorer.", gate: "A new user completes five read-only capstones without terminal help; choose optional actions or proceed to read-only packaging." },
