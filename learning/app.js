...
const milestones = [
  ...
  { id: 9, phase: 2, status: "done", title: "Usable capture and answer UI", build: "Add picker, preview, redact, retake, status, copy, and a failure explorer.", gate: "A new user completes five read-only capstones without terminal help; choose optional actions or proceed to read-only packaging." },
  { id: 10, phase: 3, status: "done", title: "Typed action intents and policy—no execution", build: "Define observe, click, type, key, scroll, cancel, finish, target preview, and consequence policy.", gate: "Adversarial proposals cannot bypass schema, scope, approval, or budget." },
  { id: 11, phase: 3, status: "done", title: "Disposable simulated action loop", build: "Run observe, propose, approve, fake execute, verify, retry, and stop in a practice app.", gate: "Tasks finish within budgets with zero host input events." },
  { id: 12, phase: 3, status: "done", title: "Read-only macOS UI grounding", build: "Align screenshot regions with Accessibility element roles, names, states, and identities.", gate: "Target identity passes across scaling and layout variants with no posted input." },
  { id: 13, phase: 3, status: "done", title: "Supervised mouse and keyboard execution", build: "Add opt-in Accessibility execution, visible target overlay, confirmation, stop, and observation.", gate: "Zero wrong-target, secret-field, approval-bypass, or stale-frame actions." },
  ...
  { id: 16, phase: 4, status: "current", title: "Evaluation and reciprocal learning field manual", build: "Consolidate the failure explorer, comparisons, quizzes, and reproduction material maintained at every milestone.", gate: "A new learner can explain, measure, modify, and safely reproduce the system." },
