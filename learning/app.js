...
const stages = {
  ...
  release: ["Custody ends explicitly", "The artifact is deleted after the turn unless retention was deliberately requested. Tests prove both default deletion and explicit retention.", "Artifact store", "Deleted by default", "No silent screenshot history"],
};
...
const milestones = [
  ...
  { id: 3, phase: 1, status: "current", title: "Explicit screenshot ingest and capture", build: "Build file ingest, user-triggered selection, bounded PNG normalization, and an ephemeral artifact lifecycle.", gate: "One user-selected region must pass the same path and be deleted by default." },
  { id: 4, phase: 1, status: "future", title: "Frozen screen-understanding corpus", build: "Create terminal, dialog, form, settings, dashboard, small-text, and insufficient-evidence cases.", gate: "Manifest, expected facts, forbidden claims, prompt, and scoring are frozen before download." },
  { id: 5, phase: 1, status: "future", title: "Local VLM and runtime bake-off", build: "Compare 4B candidates across portable llama.cpp and Apple MLX; use ≤9B only if needed.", gate: "The smallest model meeting quality, latency, memory, energy, and licence rules wins." },
  { id: 6, phase: 1, status: "future", title: "One-shot local Vision Assistant", build: "Connect selected screenshot and question to a streamed local answer with evidence labels.", gate: "Frozen capstones pass three consecutive warm trials with cold/warm metrics." },
  { id: 7, phase: 2, status: "future", title: "Evidence augmentation and focused re-observation", build: "Measure OCR, Accessibility facts, crop, zoom, and a bounded second look.", gate: "Augmentation improves the difficult subset without widening privacy or hallucination." },
  { id: 8, phase: 2, status: "future", title: "Multi-turn visual conversation", build: "Add bounded follow-ups, current-capture identity, reset, and stale-image warnings.", gate: "Reference and correction tasks pass without cross-session screenshots." },
  { id: 9, phase: 2, status: "future", title: "Usable capture and answer UI", build: "Add picker, preview, redact, retake, status, copy, and a failure explorer.", gate: "A new user completes five read-only capstones without terminal help." },
  ...
  { id: 15, phase: 4, status: "future", title: "Profiles, packaging, and offline verification", build: "Package Inspect, Balanced, and Quality profiles with permission education and uninstall.", gate: "A clean Mac reproduces read-only operation fully offline." },
  { id: 16, phase: 4, status: "future", title: "Evaluation and reciprocal learning field manual", build: "Complete failure explorer, model comparison, quizzes, teach-back, and reproduction commands.", gate: "A new learner can explain, measure, modify, and safely reproduce the system." },
