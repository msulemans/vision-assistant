...
const milestones = [
  ...
  { id: 12, phase: 3, status: "current", title: "Read-only macOS UI grounding", build: "Align screenshot regions with Accessibility element roles, names, states, and identities.", gate: "Target identity passes across scaling and layout variants with no posted input." },
